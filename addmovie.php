<?php
	...
	{		
		...
		$movieId = $_POST["txtproductId"];
		$movietName = $_POST["txtproductName"];
		...
		if ($errors != "") {
			...
			$query = "INSERT INTO movies(Id, movieName, image) VALUE ('$movieId', '$movieName','$image')";
...
?>
		...
		<form action ="addproduct.php" method = "post" enctype = "multipart/form-data">
			Product ID
			<input type = "text" name="txtmovieId"/>
			<p>
			Product Name
